...
const useDashboardStore = create()(devtools((set)=>({
        dashboardData: null,
        isLoading: false,
        setDashboardData: (dashboardData)=>set({
                dashboardData
            }),
        setLoading: (isLoading)=>set({
                isLoading
...
const useChatStore = create()(devtools(persist((set, get)=>({
        activeChatSession: null,
        chatSessions: [],
        messages: [],
        isLoading: false,
        isTyping: false,
        setActiveChatSession: (activeChatSession)=>set({
                activeChatSession
            }),
        ...
        updateChatSession: (sessionId, sessionUpdate)=>{
            const { chatSessions } = get();
            const updatedSessions = chatSessions.map((session)=>session.id === sessionId ? {
                    ...session,
                    ...sessionUpdate
                } : session);
            set({
    ...
    partialize: (state)=>({
            chatSessions: state.chatSessions.slice(0, 10),
            messages: state.messages.slice(-50)
        }),
    // Convert serialized strings back to Date objects when loading from storage
    onRehydrateStorage: ()=>{
        return (state)=>{
            if (state === null || state === void 0 ? void 0 : state.messages) {
...
function Home() {
    _s();
    const { isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen bg-gradient-to-br from-primary-darker via-primary-dark to-bg-surface flex items-center justify-center",
...
_s(Home, "59jPqtd/uZZNaclFE7ALTHeDJ+s=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"],
...
//# sourceMappingURL=_e3500ad3._.js.map