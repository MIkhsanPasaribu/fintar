      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-primary-200 mb-6 max-w-md">
              Platform pemberdayaan finansial berbasis AI yang membantu individu
              dan UKM mengelola keuangan, meningkatkan literasi finansial, dan
        ...
        <div className="border-t border-primary-400 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-primary-200 text-sm">
            © {currentYear} Fintar. All rights reserved.
          </p>
